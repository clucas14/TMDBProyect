...
let mainMovieURL = URL(string: "https://www.themoviedb.org/movie")!
let mainActorImageURL = URL(string: "https://www.themoviedb.org/t/p/w300_and_h450_bestv2")!
let wikipediaURL = URL(string: "https://es.wikipedia.org/wiki")!
let youTubeBaseULR = URL(string: "https://www.youtube.com/")!
...
extension URL {
    ...
    static func getCastMovie(id: Int) -> URL {
    ...
    static func getYouTubeTrailer(key: String) -> URL {
        URL(string: "https://www.youtube.com/watch?v=\(key)")!
//        let  url = youTubeBaseULR.appending(path: path) // No funciona
    }
}
